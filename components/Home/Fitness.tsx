  ...
  <section className='lg:pl-20 bg-cover bg-left-top bg-[url(/images/banner-bg.png)]'>
        <div className='flex flex-col-reverse lg:flex-row gap-8 3xl:container mx-auto'>
          <div className='w-full lg:w-5/12 px-6 md:px-20 lg:px-0'>
            ...
            <h2 className='font-black italic text-[30px] xl:text-[60px] 2xl:text-[92px] leading-[1.2] text-black -mt-24 pl-6 md:pl-0 pb-10 md:pb-0 md:-mt-12 xl:-mt-20 2xl:-mt-32 uppercase md:lowercase 2xl:pl-8' ><span className='text-brand-red'>Trac</span> Your Fitness </h2>
            <h3 className='font-medium italic text-xl xl:text-2xl 2xl:text-[32px] py-5 text-brand-dark lowercase 2xl:pl-8  2xl:pr-28'>TRAC is your Move-To-Earn fitness app companion to a healthier lifestyle with built-in GameFi for Web3 activities</h3>
            <p className='text-sm leading-3 md:leading-normal xl:text-xl 2xl:text-2xl font-extralight italic text-brand-dark 2xl:pl-8 2xl:pr-28 pb-6 md:pb-12'>The apex of a physical fitness within the metaverse, using NFTs and geolocation technologies.</p>
