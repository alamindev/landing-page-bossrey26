                  ...
                  <div className='flex items-center'>
                      ...
                      <div className='grid grid-cols-1 gap-10 -ml-6'>
                          <div className=''>
                              <figure className='w-full flex justify-center items-center'>
                               ...
                               <div className='relative'> 
                                    <h1 className='font-gilroy leading-[.8] text-[204px] font-black absolute text-black opacity-5 right-0 -top-10 z-10'>1</h1>
                          ...
                          <div className=''>
                             ...
                             <div className='relative '> 
                                <h1 className='font-gilroy leading-[.8] text-[204px] font-black absolute text-black opacity-5 right-0 top-0 z-10'>2</h1>
                                <div className='pt-5 relative z-20'>
                          ...
                          <div className='-ml-10 pt-10'>
                            ...
                            <div className='relative'> 
                                <h1 className='font-gilroy leading-[.8] text-[204px] font-black absolute text-black opacity-5 right-5 top-5 2xl:top-0 z-10'>3</h1>
