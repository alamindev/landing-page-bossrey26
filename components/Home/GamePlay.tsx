              ...
              <div className='grid grid-cols-3 gap-10 xl:gap-40 xl:-mt-10 2xl:-mt-32'>
                  <div className='relative w-80 px-5 -mt-10 2xl:ml-36'> 
                    ...
                    <div className='pt-5 relative z-20'>
                      ...
                      <p className='text-base font-black italic leading-[30px]'>Register with your preferred email and get the verification code.</p>
                    </div>
                  </div>
                  <div className='relative w-80 px-5 mt-10 2xl:mt-20 ml-0'> 
                    ...
                    <div className='pt-5 relative z-20'>
                      ...
                      <p className='text-base font-black italic leading-[30px]'>Get your Sneakers to start earning tokens and NFT rewards. Sneakers can be levelled up, can add attributes points and Boosters in order to amplify its performance.</p>
                    </div>
                  </div>
                  <div className='relative w-80 px-5 -mt-14'> 
                    ...
                    <div className='pt-20  pl-5 2xl:pl-0 2xl:pt-5 relative z-20'>
                      ...
                      <p className='text-base font-black italic leading-[30px]'>Earn TRAC Tokens by walking, running and moving outdoors. TRAC builds a full ecosystem including in-app wallet, swap, and marketplace so that the app is intuitive to use.</p>
                    </div>
                  </div>
                </div>
            </div>
