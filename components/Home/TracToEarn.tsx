        ...
        <div className='flex flex-col-reverse items-center lg:flex-row gap-5 2xl:gap-14 3xl:container mx-auto'>
          ...
          <div className='w-full lg:w-5/12'>
            <div className='pb-8 md:pb-16 px-6 md:px-0'>
              <h2 className='font-black italic text-[28px]  lg:text-[40px]  xl:text-[60px] 2xl:text-[80px] leading-[1.2] text-brand-dark-100 uppercase' ><span className='text-brand-red'>trac</span>-to-earn </h2>
              <h1 className='moonhouse-stroke font-moonhouse text-[96px] xl:text-[120px] 2xl:text-[180px] italic font-normal leading-4 lg:pl-10'>EARN</h1>
            </div>
