        ...
        <div className='3xl:container mx-auto'>
            <div className='flex justify-center'>
                <div className='pb-8 sm:pb-16 px-6 md:px-0'>
                    <h2 className='font-black italic text-[28px] lg:text-[40px]  xl:text-[80px]  leading-[1.2] -mb-3 text-black  uppercase md:lowercase text-center' > <span className='text-brand-red'>fair </span>  launch </h2>
                      <h1 className='moonhouse-stroke font-moonhouse text-[42px] xl:text-[100px] italic font-normal leading-4 uppercase text-center pb-5 md:pb-8'>EXCLUSIVES</h1>
                      <h3 className='text-lg md:text-[30px] lg:text-[42px] font-bold italic text-black text-center'>May 12-15, 2022 18:00 UTC</h3>
                </div>
              </div>  
                  ...
                  <div className='w-full rounded-2xl overflow-hidden border border-black shadow-[0_8px_1px_0_#000] flex flex-col md:flex-row'>
                      ...
                      <div className='p-8 md:w-6/12 flex flex-col items-center md:block'>
                          ...
                          <p className='italic text-lg lg:text-[22px] pb-14 text-center md:text-left' >Get <strong className='text-[#FCB300]'>1 of 50</strong> Limited Edition Legendary NFT Sneakers for the Top 50 Early Investors who participates in our Official Fair Launch on Pinksale.</p>
                           <a href="https://www.pinksale.finance/" target="_blank" className='md:w-full inline-block text-center rounded-lg px-5 py-3 bg-[#DF1B3F] text-white font-black text-xl lg:text-[26px] italic'>Join Fair Launch Now!</a>
                      </div>
                  </div>
              </div>
        </div>
